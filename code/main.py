...
if model_name=="bert_pretrained":
	...
	test_y2 = np.asarray(test_y2)
	train_x3s = np.asarray(train_x3s)
	train_x3w = np.asarray(train_x3w)
	train_y3 = np.asarray(train_y3)
	test_x3s = np.asarray(test_x3s)
	test_x3w = np.asarray(test_x3w)
	test_y3 = np.asarray(test_y3)
	train_x1 = pca.fit_transform(train_x1)
	train_y1 = pca.fit_transform(train_y1)
	test_x1 = pca.fit_transform(test_x1)
	test_y1 = pca.fit_transform(test_y1)
	train_x2 = pca.fit_transform(train_x2)
	train_y2 = pca.fit_transform(train_y2)
	test_x2 = pca.fit_transform(test_x2)
	test_y2 = pca.fit_transform(test_y2)
	train_x3s = pca.fit_transform(train_x3s)
	train_x3w = pca.fit_transform(train_x3w)
	train_y3 = pca.fit_transform(train_y3)
	test_x3s = pca.fit_transform(test_x3s)
	test_x3w = pca.fit_transform(test_x3w)
	test_y3 = pca.fit_transform(test_y3)
